...
// MARK: - Color ConstantsModel -

private enum ConstantsModel {
...
struct PaymentFormStyleCustom1: PaymentFormStyle {
  var backgroundColor: UIColor = ConstantsModel.backgroundColor
...
struct BillingFormStyleCustom1: BillingFormStyle {
  var mainBackground: UIColor = ConstantsModel.backgroundColor
...
private enum StyleOrganiser {
  ...
  struct BillingHeaderLabel: ElementStyle {
        ...
        var backgroundColor: UIColor = .clear
        var textColor: UIColor = ConstantsModel.mainFontColor
    }
    ...
    struct PayButtonFormStyleCustom1: ElementButtonStyle {
      ...
      var disabledTextColor: UIColor = ConstantsModel.secondaryFontColor
      var disabledTintColor: UIColor = ConstantsModel.mainFontColor.withAlphaComponent(0.2)
      var activeTintColor: UIColor = ConstantsModel.mainFontColor
      var backgroundColor: UIColor = ConstantsModel.mainFontColor
    ...
    struct TextFieldStyle: ElementTextFieldStyle {
        ...
        var tintColor: UIColor = ConstantsModel.mainFontColor
        var isHidden = false
        var font = UIFont(size: 15)
        var backgroundColor: UIColor = ConstantsModel.textFieldBackgroundColor
        var textColor: UIColor = ConstantsModel.mainFontColor
    }

    struct BorderStyle: ElementBorderStyle {
        var cornerRadius: CGFloat = ConstantsModel.borderRadius
        var borderWidth: CGFloat = ConstantsModel.borderWidth
        var normalColor: UIColor = .clear
        var focusColor: UIColor = .clear
        var errorColor: UIColor = ConstantsModel.errorColor
    ...
    struct MandatoryStyle: ElementStyle {
        ...
        var backgroundColor: UIColor = .clear
        var textColor: UIColor = ConstantsModel.secondaryFontColor
    }
    ...
    struct ErrorViewStyle: ElementErrorViewStyle {
        var textAlignment: NSTextAlignment = .natural
        var text: String
        var textColor: UIColor = ConstantsModel.errorColor
        var backgroundColor: UIColor = .clear
        var tintColor: UIColor = ConstantsModel.errorColor
        var image: UIImage?
        var height: Double = 30
        var isHidden = true
        var font = UIFont(size: 13)
    ...
    struct BillingStartButton: CellButtonStyle {
        ...
        var hint: ElementStyle? = {
            ...
            element.textColor = ConstantsModel.mainFontColor
            return element
        }()
    ...
    struct BillingSummaryStyle: BillingSummaryViewStyle {
        ...
        var cornerRadius: CGFloat = ConstantsModel.borderRadius
        var separatorLineColor: UIColor = ConstantsModel.secondaryFontColor
    ...
    struct AddBillingDetailsButtonStyle: ElementButtonStyle {
        ...
        var isEnabled = true
        var disabledTextColor: UIColor = ConstantsModel.secondaryFontColor
        var disabledTintColor: UIColor = ConstantsModel.secondaryFontColor
        var activeTintColor: UIColor = ConstantsModel.mainFontColor
        var imageTintColor: UIColor = .clear
        var image: UIImage?
        var textLeading: CGFloat = 0
    ...
    struct BillingCountryButton: ElementButtonStyle {
        ...
        var disabledTintColor: UIColor = .clear
        var activeTintColor: UIColor = ConstantsModel.mainFontColor
        var imageTintColor: UIColor = ConstantsModel.mainFontColor
